...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('workspaces')->group(function () {
        ...
        Route::get('/{workspaceId}/assignments/{assignmentId}/submissions', [SubmissionController::class, 'index']);
        Route::get('/{workspace}', [WorkspaceController::class, 'getWorkspaceById']);
    });
